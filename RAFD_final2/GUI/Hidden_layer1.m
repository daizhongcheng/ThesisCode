function varargout = Hidden_layer1(varargin)
% HIDDEN_LAYER1 MATLAB code for Hidden_layer1.fig
%      HIDDEN_LAYER1, by itself, creates a new HIDDEN_LAYER1 or raises the existing
%      singleton*.
%
%      H = HIDDEN_LAYER1 returns the handle to a new HIDDEN_LAYER1 or the handle to
%      the existing singleton*.
%
%      HIDDEN_LAYER1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in HIDDEN_LAYER1.M with the given input arguments.
%
%      HIDDEN_LAYER1('Property','Value',...) creates a new HIDDEN_LAYER1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Hidden_layer1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Hidden_layer1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Hidden_layer1

% Last Modified by GUIDE v2.5 09-Feb-2017 12:19:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Hidden_layer1_OpeningFcn, ...
                   'gui_OutputFcn',  @Hidden_layer1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Hidden_layer1 is made visible.
function Hidden_layer1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Hidden_layer1 (see VARARGIN)

% Choose default command line output for Hidden_layer1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Hidden_layer1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Hidden_layer1_OutputFcn(hObject, eventdata, handles) 
...
if (pr10<0)||(pr10>100)
    ...
    if (pr01<0)||(pr01>100)
        ...
        if (pr11<0)||(pr11>100)
            ...
            if sum==100
                load('fileData.mat');
                f_parameter.Hidden_pro(1,:,FaultNr_now) = [pr01 pr10 pr11];
