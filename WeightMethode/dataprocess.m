...
n1 = 10;
Wh = [0.5 1 1.5 2 2.5 3 3.5 4 5 6] ;
Wh = diag(Wh);
EN = [J_N_data' dis_Rim'] ;
...
EN1 = SlideWeight(EN,Wh,n1) ;
EA1 = SlideWeight(EA,Wh,n1) ;
EM1 = SlideWeight(EM,Wh,n1) ;
EAL1 = SlideWeight(EAL,Wh,n1);
XS = [EN1;EA1;EM1;EAL1] ;
[m n] = size(EN1);
theclass1 = -ones(m,1); % generate m numbers value 1
[m n] = size(EA1);
...
[m n] = size(EAL1);
theclass4 = 3*ones(m,1);  
Ys = [theclass1;theclass2;theclass3;theclass4];
figure('name','SliedeWeight methode')
gscatter(XS(:,1),XS(:,2),Ys,['k' 'r' 'b' 'y'],['o' '+' '*' 's']);
